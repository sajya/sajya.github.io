    ...
    <div class="container">
        <div class="px-4 py-md-5 my-5 text-center">
            <div class="col-lg-8 mx-auto text-start">
                ...
                <p class="lead mb-4">Sajya is an open-source package for Laravel that makes it easy to implement the JSON-RPC 2.0 server specification including validation of parameters, support for batch and notification requests, and more.</p>
                ...
                <div class="pt-2" id="featured-3">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-12">
                            <h5>Agnostic of the client-side technology.</h5>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 py-md-5 py-3 row-cols-1 row-cols-lg-3">
                        <div class="feature col">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="fw-normal ms-3">Web</h3>
                            </div>
                            <p>
                        ...
                        <div class="feature col">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="fw-normal ms-3">Mobile</h3>
                            </div>
                            <p>
                        ...
                        <div class="feature col">
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="fw-normal ms-3">IoT</h3>
                            </div>
                            <p>Something electronic on Rust, Go, C, Java? No problem at all. </p>
                        </div>
                    </div>
                </div>
            </div>
