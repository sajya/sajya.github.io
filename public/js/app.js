...
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('bash', (highlight_js_lib_languages_bash__WEBPACK_IMPORTED_MODULE_4___default()));
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('javascript', (highlight_js_lib_languages_javascript__WEBPACK_IMPORTED_MODULE_2___default()));
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('php', (highlight_js_lib_languages_php__WEBPACK_IMPORTED_MODULE_3___default()));
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('html', (highlight_js_lib_languages_xml__WEBPACK_IMPORTED_MODULE_5___default()));
highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().registerLanguage('json', (highlight_js_lib_languages_json__WEBPACK_IMPORTED_MODULE_6___default()));
...
if (document.getElementById("console")) {
  ...
  var txt = ['--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": "subtract", "params": [42, 23], "id": 1}').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "result": 19, "id": 1}').value, '<span class="text-primary">---</span>', '--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": "subtract", "params": [23, 42], "id": 2}').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "result": -19, "id": 2}').value, '<span class="text-primary">---</span>', '--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": "subtract", "params": {"subtrahend": 23, "minuend": 42}, "id": 3}').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "result": 19, "id": 3}').value, '<span class="text-primary">---</span>', '--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": "subtract", "params": {"minuend": 42, "subtrahend": 23}, "id": 4}').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "result": 19, "id": 4}').value, '<span class="text-primary">---</span>', '--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": "foobar", "id": 10}').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "error": {"code": -32601, "message": "Procedure not found."}, "id": 10}').value, '<span class="text-primary">---</span>', '--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": "foobar", "params": "bar", "baz"]').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "error": {"code": -32700, "message": "Parse error"}, "id": null}').value, '<span class="text-primary">---</span>', '--> ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "method": 1, "params": "bar"}').value, '<-- ' + highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_0___default().highlightAuto('{"jsonrpc": "2.0", "error": {"code": -32600, "message": "Invalid JSON-RPC."}, "id": null}').value, '<span class="text-primary">---</span>'];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var nav = document.querySelector('.nav-docs');
  if (!nav) {
    return;
  }
